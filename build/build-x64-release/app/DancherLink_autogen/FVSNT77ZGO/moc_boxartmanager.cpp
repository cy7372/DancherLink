...
namespace {
struct qt_meta_tag_ZN21NetworkBoxArtLoadTaskE_t {};
} // unnamed namespace

template <> constexpr inline auto NetworkBoxArtLoadTask::qt_create_metaobjectdata<qt_meta_tag_ZN21NetworkBoxArtLoadTaskE_t>()
{
    namespace QMC = QtMocConstants;
    QtMocHelpers::StringRefStorage qt_stringData {
        "NetworkBoxArtLoadTask",
        "boxArtFetchCompleted",
        "",
        "NvComputer*",
        "computer",
        "NvApp",
    ...
    return QtMocHelpers::metaObjectData<NetworkBoxArtLoadTask, qt_meta_tag_ZN21NetworkBoxArtLoadTaskE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject NetworkBoxArtLoadTask::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN21NetworkBoxArtLoadTaskE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN21NetworkBoxArtLoadTaskE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN21NetworkBoxArtLoadTaskE_t>.metaTypes,
    nullptr
} };

void NetworkBoxArtLoadTask::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    auto *_t = static_cast<NetworkBoxArtLoadTask *>(_o);
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->boxArtFetchCompleted((*reinterpret_cast<std::add_pointer_t<NvComputer*>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<NvApp>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<QUrl>>(_a[3]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::RegisterMethodArgumentMetaType) {
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (NetworkBoxArtLoadTask::*)(NvComputer * , NvApp , QUrl )>(_a, &NetworkBoxArtLoadTask::boxArtFetchCompleted, 0))
            return;
    }
}

const QMetaObject *NetworkBoxArtLoadTask::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *NetworkBoxArtLoadTask::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN21NetworkBoxArtLoadTaskE_t>.strings))
        return static_cast<void*>(this);
...
int NetworkBoxArtLoadTask::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QObject::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
...
// SIGNAL 0
void NetworkBoxArtLoadTask::boxArtFetchCompleted(NvComputer * _t1, NvApp _t2, QUrl _t3)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1, _t2, _t3);
}
QT_WARNING_POP
