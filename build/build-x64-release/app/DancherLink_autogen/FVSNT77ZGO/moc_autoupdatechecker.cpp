...
template <> constexpr inline auto AutoUpdateChecker::qt_create_metaobjectdata<qt_meta_tag_ZN17AutoUpdateCheckerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(QString, bool)>(7, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 8 }, { QMetaType::Bool, 5 },
        }}),
        // Slot 'handleUpdateCheckRequestFinished'
        QtMocHelpers::SlotData<void(QNetworkReply *)>(9, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 10, 11 },
        }}),
        // Slot 'onUpdateManifestReceived'
        QtMocHelpers::SlotData<void(const QByteArray &, bool)>(12, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::QByteArray, 13 }, { QMetaType::Bool, 5 },
        }}),
        // Slot 'onUpdateCheckFailed'
        ...
        // Method 'start'
        QtMocHelpers::MethodData<void()>(15, 2, QMC::AccessPublic | QMC::MethodCloned, QMetaType::Void),
    };
...
void AutoUpdateChecker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->updateAvailable((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<bool>>(_a[3]))); break;
        case 1: _t->noUpdateAvailable((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1]))); break;
        case 2: _t->updateCheckFailed((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<bool>>(_a[2]))); break;
        case 3: _t->handleUpdateCheckRequestFinished((*reinterpret_cast<std::add_pointer_t<QNetworkReply*>>(_a[1]))); break;
        case 4: _t->onUpdateManifestReceived((*reinterpret_cast<std::add_pointer_t<QByteArray>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<bool>>(_a[2]))); break;
        case 5: _t->onUpdateCheckFailed((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<bool>>(_a[2]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (AutoUpdateChecker::*)(QString , QString , bool )>(_a, &AutoUpdateChecker::updateAvailable, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (AutoUpdateChecker::*)(bool )>(_a, &AutoUpdateChecker::noUpdateAvailable, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (AutoUpdateChecker::*)(QString , bool )>(_a, &AutoUpdateChecker::updateCheckFailed, 2))
            return;
    }
}
...
// SIGNAL 0
void AutoUpdateChecker::updateAvailable(QString _t1, QString _t2, bool _t3)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1, _t2, _t3);
}

// SIGNAL 1
void AutoUpdateChecker::noUpdateAvailable(bool _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 1, nullptr, _t1);
}

// SIGNAL 2
void AutoUpdateChecker::updateCheckFailed(QString _t1, bool _t2)
{
