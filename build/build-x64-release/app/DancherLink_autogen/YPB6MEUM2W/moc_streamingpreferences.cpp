...
template <> constexpr inline auto StreamingPreferences::qt_create_metaobjectdata<qt_meta_tag_ZN20StreamingPreferencesE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'updateSubscriptionUrlChanged'
        ...
        QtMocHelpers::MethodData<int(int, int, int, bool)>(41, 2, QMC::AccessPublic, QMetaType::Int, {{
            { QMetaType::Int, 42 }, { QMetaType::Int, 43 }, { QMetaType::Int, 44 }, { QMetaType::Bool, 45 },
        }}),
        // Method 'save'
    ...
    QtMocHelpers::UintData qt_properties {
        ...
        QtMocHelpers::PropertyData<int>(48, QMetaType::Int, QMC::DefaultPropertyFlags | QMC::Writable, 1),
        // property 'unlockBitrate'
        QtMocHelpers::PropertyData<bool>(49, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 2),
        // property 'autoAdjustBitrate'
        QtMocHelpers::PropertyData<bool>(50, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 3),
        // property 'enableVsync'
        QtMocHelpers::PropertyData<bool>(51, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 4),
        // property 'gameOptimizations'
        QtMocHelpers::PropertyData<bool>(52, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 5),
        // property 'playAudioOnHost'
        QtMocHelpers::PropertyData<bool>(53, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 6),
        // property 'multiController'
        QtMocHelpers::PropertyData<bool>(54, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 7),
        // property 'enableMdns'
        QtMocHelpers::PropertyData<bool>(55, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 9),
        // property 'quitAppAfter'
        QtMocHelpers::PropertyData<bool>(56, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 10),
        // property 'absoluteMouseMode'
        QtMocHelpers::PropertyData<bool>(57, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 11),
        // property 'absoluteTouchMode'
        QtMocHelpers::PropertyData<bool>(58, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 12),
        // property 'framePacing'
        QtMocHelpers::PropertyData<bool>(59, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 20),
        // property 'connectionWarnings'
        QtMocHelpers::PropertyData<bool>(60, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 21),
        // property 'configurationWarnings'
        QtMocHelpers::PropertyData<bool>(61, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 22),
        // property 'richPresence'
        QtMocHelpers::PropertyData<bool>(62, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 23),
        // property 'gamepadMouse'
        QtMocHelpers::PropertyData<bool>(63, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 24),
        // property 'detectNetworkBlocking'
        QtMocHelpers::PropertyData<bool>(64, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 25),
        // property 'showPerformanceOverlay'
        QtMocHelpers::PropertyData<bool>(65, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 26),
        ...
        QtMocHelpers::PropertyData<bool>(79, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 27),
        // property 'muteOnFocusLoss'
        QtMocHelpers::PropertyData<bool>(80, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 28),
        // property 'backgroundGamepad'
        QtMocHelpers::PropertyData<bool>(81, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 29),
        // property 'reverseScrollDirection'
        QtMocHelpers::PropertyData<bool>(82, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 30),
        // property 'swapFaceButtons'
        QtMocHelpers::PropertyData<bool>(83, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 31),
        // property 'keepAwake'
        QtMocHelpers::PropertyData<bool>(84, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 33),
        // property 'quitOnDisplaySleep'
        QtMocHelpers::PropertyData<bool>(85, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 34),
        // property 'detectResolutionChange'
        QtMocHelpers::PropertyData<bool>(86, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 35),
        // property 'enableMicrophone'
        QtMocHelpers::PropertyData<bool>(87, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 36),
        // property 'updateSubscriptionUrl'
        QtMocHelpers::PropertyData<QString>(88, QMetaType::QString, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet, 37),
        // property 'captureSysKeysMode'
        QtMocHelpers::PropertyData<enum CaptureSysKeysMode>(89, 0x80000000 | 90, QMC::DefaultPropertyFlags | QMC::Writable | QMC::EnumOrFlag, 32),
        // property 'language'
        QtMocHelpers::PropertyData<enum Language>(91, 0x80000000 | 92, QMC::DefaultPropertyFlags | QMC::Writable | QMC::EnumOrFlag, 38),
    };
    QtMocHelpers::UintData qt_enums {
        // enum 'AudioConfig'
        QtMocHelpers::EnumData<enum AudioConfig>(67, 67, QMC::EnumFlags{}).add({
            {   93, AudioConfig::AC_STEREO },
            {   94, AudioConfig::AC_51_SURROUND },
            {   95, AudioConfig::AC_71_SURROUND },
        }),
        // enum 'VideoCodecConfig'
        QtMocHelpers::EnumData<enum VideoCodecConfig>(69, 69, QMC::EnumFlags{}).add({
            {   96, VideoCodecConfig::VCC_AUTO },
            {   97, VideoCodecConfig::VCC_FORCE_H264 },
            {   98, VideoCodecConfig::VCC_FORCE_HEVC },
            {   99, VideoCodecConfig::VCC_FORCE_HEVC_HDR_DEPRECATED },
            {  100, VideoCodecConfig::VCC_FORCE_AV1 },
        }),
        // enum 'VideoDecoderSelection'
        QtMocHelpers::EnumData<enum VideoDecoderSelection>(73, 73, QMC::EnumFlags{}).add({
            {  101, VideoDecoderSelection::VDS_AUTO },
            {  102, VideoDecoderSelection::VDS_FORCE_HARDWARE },
            {  103, VideoDecoderSelection::VDS_FORCE_SOFTWARE },
        }),
        // enum 'WindowMode'
        QtMocHelpers::EnumData<enum WindowMode>(75, 75, QMC::EnumFlags{}).add({
            {  104, WindowMode::WM_FULLSCREEN },
            {  105, WindowMode::WM_FULLSCREEN_DESKTOP },
            {  106, WindowMode::WM_WINDOWED },
        }),
        // enum 'UIDisplayMode'
        QtMocHelpers::EnumData<enum UIDisplayMode>(78, 78, QMC::EnumFlags{}).add({
            {  107, UIDisplayMode::UI_WINDOWED },
            {  108, UIDisplayMode::UI_MAXIMIZED },
            {  109, UIDisplayMode::UI_FULLSCREEN },
        }),
        // enum 'Language'
        QtMocHelpers::EnumData<enum Language>(92, 92, QMC::EnumFlags{}).add({
            {  110, Language::LANG_AUTO },
            {  111, Language::LANG_EN },
            {  112, Language::LANG_FR },
            {  113, Language::LANG_ZH_CN },
            {  114, Language::LANG_DE },
            {  115, Language::LANG_NB_NO },
            {  116, Language::LANG_RU },
            {  117, Language::LANG_ES },
            {  118, Language::LANG_JA },
            {  119, Language::LANG_VI },
            {  120, Language::LANG_TH },
            {  121, Language::LANG_KO },
            {  122, Language::LANG_HU },
            {  123, Language::LANG_NL },
            {  124, Language::LANG_SV },
            {  125, Language::LANG_TR },
            {  126, Language::LANG_UK },
            {  127, Language::LANG_ZH_TW },
            {  128, Language::LANG_PT },
            {  129, Language::LANG_PT_BR },
            {  130, Language::LANG_EL },
            {  131, Language::LANG_IT },
            {  132, Language::LANG_HI },
            {  133, Language::LANG_PL },
            {  134, Language::LANG_CS },
            {  135, Language::LANG_HE },
            {  136, Language::LANG_CKB },
            {  137, Language::LANG_LT },
            {  138, Language::LANG_ET },
            {  139, Language::LANG_BG },
            {  140, Language::LANG_EO },
            {  141, Language::LANG_TA },
        }),
        // enum 'CaptureSysKeysMode'
        QtMocHelpers::EnumData<enum CaptureSysKeysMode>(90, 90, QMC::EnumFlags{}).add({
            {  142, CaptureSysKeysMode::CSK_OFF },
            {  143, CaptureSysKeysMode::CSK_FULLSCREEN },
            {  144, CaptureSysKeysMode::CSK_ALWAYS },
        }),
    };
...
void StreamingPreferences::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 37: _t->updateSubscriptionUrlChanged(); break;
        case 38: _t->languageChanged(); break;
        case 39: { int _r = _t->getDefaultBitrate((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[3])),(*reinterpret_cast<std::add_pointer_t<bool>>(_a[4])));
            if (_a[0]) *reinterpret_cast<int*>(_a[0]) = std::move(_r); }  break;
        case 40: _t->save(); break;
        case 41: { bool _r = _t->retranslate();
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (StreamingPreferences::*)()>(_a, &StreamingPreferences::enableMicrophoneChanged, 36))
            return;
        if (QtMocHelpers::indexOfMethod<void (StreamingPreferences::*)()>(_a, &StreamingPreferences::updateSubscriptionUrlChanged, 37))
            return;
        if (QtMocHelpers::indexOfMethod<void (StreamingPreferences::*)()>(_a, &StreamingPreferences::languageChanged, 38))
            return;
    }
    if (_c == QMetaObject::ReadProperty) {
        ...
        case 38: *reinterpret_cast<QString*>(_v) = _t->getUpdateSubscriptionUrl(); break;
        case 39: *reinterpret_cast<enum CaptureSysKeysMode*>(_v) = _t->captureSysKeysMode; break;
        case 40: *reinterpret_cast<enum Language*>(_v) = _t->language; break;
        default: break;
        }
    }
    if (_c == QMetaObject::WriteProperty) {
        ...
        case 37:
            ...
            break;
        case 38: _t->setUpdateSubscriptionUrl(*reinterpret_cast<QString*>(_v)); break;
        case 39:
...
// SIGNAL 37
void StreamingPreferences::updateSubscriptionUrlChanged()
{
