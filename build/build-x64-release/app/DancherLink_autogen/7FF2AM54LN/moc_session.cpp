...
template <> constexpr inline auto Session::qt_create_metaobjectdata<qt_meta_tag_ZN7SessionE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Method 'initialize'
        QtMocHelpers::MethodData<bool(QQuickWindow *)>(17, 2, QMC::AccessPublic, QMetaType::Bool, {{
            { 0x80000000 | 18, 19 },
        }}),
        // Method 'start'
        ...
        // Method 'waitForHostOnline'
        QtMocHelpers::MethodData<void()>(22, 2, QMC::AccessPublic, QMetaType::Void),
    };
    QtMocHelpers::UintData qt_properties {
        // property 'launchWarnings'
        QtMocHelpers::PropertyData<QStringList>(23, QMetaType::QStringList, QMC::DefaultPropertyFlags | QMC::Writable, 9),
    };
...
void Session::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: _t->sessionRestartRequested(); break;
        case 7: _t->hostReady(); break;
        case 8: _t->readyForDeletion(); break;
        case 9: _t->launchWarningsChanged(); break;
        case 10: { bool _r = _t->initialize((*reinterpret_cast<std::add_pointer_t<QQuickWindow*>>(_a[1])));
            if (_a[0]) *reinterpret_cast<bool*>(_a[0]) = std::move(_r); }  break;
        case 11: _t->start(); break;
        case 12: _t->interrupt(); break;
        case 13: _t->waitForHostOnline(); break;
        default: ;
        }
    }
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (Session::*)(int )>(_a, &Session::sessionFinished, 5))
            return;
        if (QtMocHelpers::indexOfMethod<void (Session::*)()>(_a, &Session::sessionRestartRequested, 6))
            return;
        if (QtMocHelpers::indexOfMethod<void (Session::*)()>(_a, &Session::hostReady, 7))
            return;
        if (QtMocHelpers::indexOfMethod<void (Session::*)()>(_a, &Session::readyForDeletion, 8))
            return;
        if (QtMocHelpers::indexOfMethod<void (Session::*)()>(_a, &Session::launchWarningsChanged, 9))
            return;
    }
...
// SIGNAL 6
void Session::sessionRestartRequested()
{
    QMetaObject::activate(this, &staticMetaObject, 6, nullptr);
}

// SIGNAL 7
void Session::hostReady()
{
