...
namespace {
struct qt_meta_tag_ZN26DeferredTestConnectionTaskE_t {};
} // unnamed namespace

template <> constexpr inline auto DeferredTestConnectionTask::qt_create_metaobjectdata<qt_meta_tag_ZN26DeferredTestConnectionTaskE_t>()
{
    namespace QMC = QtMocConstants;
    QtMocHelpers::StringRefStorage qt_stringData {
        "DeferredTestConnectionTask",
        "connectionTestCompleted",
        "",
        "result",
        "blockedPorts"
    ...
    return QtMocHelpers::metaObjectData<DeferredTestConnectionTask, qt_meta_tag_ZN26DeferredTestConnectionTaskE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject DeferredTestConnectionTask::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN26DeferredTestConnectionTaskE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN26DeferredTestConnectionTaskE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN26DeferredTestConnectionTaskE_t>.metaTypes,
    nullptr
} };

void DeferredTestConnectionTask::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    auto *_t = static_cast<DeferredTestConnectionTask *>(_o);
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->connectionTestCompleted((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (DeferredTestConnectionTask::*)(int , QString )>(_a, &DeferredTestConnectionTask::connectionTestCompleted, 0))
            return;
    }
}

const QMetaObject *DeferredTestConnectionTask::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *DeferredTestConnectionTask::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN26DeferredTestConnectionTaskE_t>.strings))
        return static_cast<void*>(this);
...
int DeferredTestConnectionTask::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void DeferredTestConnectionTask::connectionTestCompleted(int _t1, QString _t2)
{
