...
public:
    ...
    // Getters and Setters for resolution
    ...
    Q_PROPERTY(int width READ getWidth WRITE setWidth NOTIFY displayModeChanged)
    Q_PROPERTY(int height READ getHeight WRITE setHeight NOTIFY displayModeChanged)
    Q_PROPERTY(int fps MEMBER fps NOTIFY displayModeChanged)
    Q_PROPERTY(int bitrateKbps MEMBER bitrateKbps NOTIFY bitrateChanged)
    Q_PROPERTY(bool unlockBitrate MEMBER unlockBitrate NOTIFY unlockBitrateChanged)
    Q_PROPERTY(bool autoAdjustBitrate MEMBER autoAdjustBitrate NOTIFY autoAdjustBitrateChanged)
    Q_PROPERTY(bool networkAdaptiveBitrate MEMBER networkAdaptiveBitrate NOTIFY networkAdaptiveBitrateChanged)
    ...
    QString getUpdateSubscriptionUrl() const { return updateSubscriptionUrl; }
    void setUpdateSubscriptionUrl(QString url);
...
signals:
    ...
    void networkAdaptiveBitrateChanged();
