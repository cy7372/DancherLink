...
Page {
    ...
    // Use imperative connections to ensure we receive signals from the singleton correctly
    Component.onCompleted: {
        // Signals are handled globally in main.qml now
    }

    Component.onDestruction: {
        // Also save preferences on destruction
    ...
    Flickable {
        ...
        function isChildOfFlickable(item) {
            while (item) {
                if (item.parent === flickable.contentItem) {
                    return true
                }
                ...
                Column {
                    ...
                    AutoResizingComboBox {
                        function createModel() {
                            var model = Qt.createQmlObject('import QtQuick 2.15; ListModel {}', parent, '')
            ...
            GroupBox {
                ...
                Column {
                    ...
                    CheckBox {
                        ...
                        enabled: resolutionListModel.get(resolutionComboBox.currentIndex).video_width === "0"
