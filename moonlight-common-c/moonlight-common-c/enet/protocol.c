...
enet_protocol_handle_connect (ENetHost * host, ENetProtocolHeader * header, ENetProtocol * command)
{
    ...
    verifyCommand.header.command = (enet_uint8) ((int)ENET_PROTOCOL_COMMAND_VERIFY_CONNECT | (int)ENET_PROTOCOL_COMMAND_FLAG_ACKNOWLEDGE);
...
enet_protocol_handle_incoming_commands (ENetHost * host, ENetEvent * event)
{
    ...
    flags = peerID & (enet_uint16) ENET_PROTOCOL_HEADER_FLAG_MASK;
    peerID &= ~ (enet_uint16) ((int)ENET_PROTOCOL_HEADER_FLAG_MASK | (int)ENET_PROTOCOL_HEADER_SESSION_MASK);
