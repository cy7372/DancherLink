...
enet_peer_throttle_configure (ENetPeer * peer, enet_uint32 interval, enet_uint32 acceleration, enet_uint32 deceleration)
{
    ...
    command.header.command = (enet_uint8) ((int)ENET_PROTOCOL_COMMAND_THROTTLE_CONFIGURE | (int)ENET_PROTOCOL_COMMAND_FLAG_ACKNOWLEDGE);
...
enet_peer_send (ENetPeer * peer, enet_uint8 channelID, ENetPacket * packet)
{
   ...
   if (packet -> dataLength > fragmentLength)
   {
      ...
      {
         commandNumber = (enet_uint8) ((int)ENET_PROTOCOL_COMMAND_SEND_FRAGMENT | (int)ENET_PROTOCOL_COMMAND_FLAG_ACKNOWLEDGE);
   ...
   {
      command.header.command = (enet_uint8) ((int)ENET_PROTOCOL_COMMAND_SEND_UNSEQUENCED | (int)ENET_PROTOCOL_COMMAND_FLAG_UNSEQUENCED);
      command.sendUnsequenced.dataLength = ENET_HOST_TO_NET_16 (packet -> dataLength);
   }
   else 
   if (packet -> flags & ENET_PACKET_FLAG_RELIABLE || channel -> outgoingUnreliableSequenceNumber >= 0xFFFF)
   {
      command.header.command = (enet_uint8) ((int)ENET_PROTOCOL_COMMAND_SEND_RELIABLE | (int)ENET_PROTOCOL_COMMAND_FLAG_ACKNOWLEDGE);
      command.sendReliable.dataLength = ENET_HOST_TO_NET_16 (packet -> dataLength);
   }
   else
   {
      command.header.command = (enet_uint8) ((int)ENET_PROTOCOL_COMMAND_SEND_UNRELIABLE);
...
enet_peer_ping (ENetPeer * peer)
{
    ...
    command.header.command = (enet_uint8) ((int)ENET_PROTOCOL_COMMAND_PING | (int)ENET_PROTOCOL_COMMAND_FLAG_ACKNOWLEDGE);
    command.header.channelID = 0xFF;
...
enet_peer_disconnect_now (ENetPeer * peer, enet_uint32 data)
{
        ...
        peer -> state != ENET_PEER_STATE_DISCONNECTING)
    {
        ...
        command.header.command = (enet_uint8) ((int)ENET_PROTOCOL_COMMAND_DISCONNECT | (int)ENET_PROTOCOL_COMMAND_FLAG_UNSEQUENCED);
        command.header.channelID = 0xFF;
...
enet_peer_disconnect (ENetPeer * peer, enet_uint32 data)
{
    ...
    if (peer -> state == ENET_PEER_STATE_CONNECTED || peer -> state == ENET_PEER_STATE_DISCONNECT_LATER)
      command.header.command |= (enet_uint8) ENET_PROTOCOL_COMMAND_FLAG_ACKNOWLEDGE;
    else
      command.header.command |= (enet_uint8) ENET_PROTOCOL_COMMAND_FLAG_UNSEQUENCED;      
