...
enet_host_connect (ENetHost * host, const ENetAddress * address, size_t channelCount, enet_uint32 data)
{
    ...
    command.header.command = (enet_uint8) ((int)ENET_PROTOCOL_COMMAND_CONNECT | (int)ENET_PROTOCOL_COMMAND_FLAG_ACKNOWLEDGE);
...
enet_host_bandwidth_throttle (ENetHost * host)
{
    ...
    if (host -> recalculateBandwidthLimits)
    {
            ...
            ++ peer)
       {
           ...
           command.header.command = (enet_uint8) ((int)ENET_PROTOCOL_COMMAND_BANDWIDTH_LIMIT | (int)ENET_PROTOCOL_COMMAND_FLAG_ACKNOWLEDGE);
           command.header.channelID = 0xFF;
